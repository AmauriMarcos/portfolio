    ...
    <div className={styles.Work}>
        <div className={styles.firstRow}>
            ...
            <div className={styles.description}>
                <h2>KFÉ News</h2>
                <p>My name is Amauri Santos and I am a passionate front end developer based in Serbia.  I am always looking for a good challenge. 
                I enjoy making full applications with the MERN stack.
                I like to read, play video games,  running and stay with my family.</p>
            </div>
        </div>
